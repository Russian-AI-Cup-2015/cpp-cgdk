...
Car::Car()
        ...
        nextWaypointX(-1), nextWaypointY(-1), finishedTrack(false) { }
...
Car::Car(long long id, double mass, double x, double y, double speedX, double speedY, double angle, double angularSpeed,
        ...
        int nextWaypointY, bool finishedTrack)
        ...
        enginePower(enginePower), wheelTurn(wheelTurn), nextWaypointX(nextWaypointX), nextWaypointY(nextWaypointY),
